...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.1/js/bootstrap.min.js" integrity="sha384-smHYKdLADwkXOn1EmN1qk/HfnUcbVRZyYmZ4qpPea6sjB/pTJ0euyQp0Mk8ck+5T" crossorigin="anonymous"></script>
    ...
    <body>
        <div id="container">
            ...
            <h1><center>St Julians Restaurants: </center></h1>
            <div id="main">
                
            <?php
                 $conn = mysqli_connect('localhost', 'root','','hungry', '3307') or die('Cannot connect to DB');	 
                $query = "select rastaurantName from restaurant where  localityId='8';";
                $result = mysqli_query($conn, $query);
                $row = mysqli_fetch_assoc($result);
                    if (mysqli_num_rows($result) > 0) {
                        if ($row['rastaurantName'] == 'St Julians') {
                        echo "<h2><center><a href='hugos.php'><font color='black'>$row[rastaurantName]</font><a></center></h2>";}
                    }
            ?>
