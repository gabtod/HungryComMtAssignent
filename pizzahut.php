...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.1/js/bootstrap.min.js" integrity="sha384-smHYKdLADwkXOn1EmN1qk/HfnUcbVRZyYmZ4qpPea6sjB/pTJ0euyQp0Mk8ck+5T" crossorigin="anonymous"></script>
    ...
    <body>
        <div id="container">
            ...
            <h1><center>Pizza Hut offers: </center></h1>
            <div id="main">
                ...
                where restaurantitem.restaurantIId=2";
                $result =mysqli_query($conn,$query);
                //$_SESSION['arrayOkurama'] = array();
                
                if(!isset($_SESSION['arrayPizza'])){
                ...
                while($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<form method='POST' action='pizzahut.php'><a href='#'><b>$row[itemName] </b></a> Price &#x20AC; $row[itemPrice] <br>";
                    if (isset($_SESSION['username']) && (isset($_SESSION['password']))) { 
